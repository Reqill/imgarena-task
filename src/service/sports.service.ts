  ...
  items: [
    {
      ...
      description:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus nisl enim, faucibus ac mattis sit amet, ullamcorper at arcu. Donec pulvinar hendrerit tristique. Integer pharetra, arcu id vehicula lacinia, odio lectus pellentesque quam, sed finibus mauris massa at lectus.",
    },
    {
      id: 2,
      name: "Basketball",
      ...
      description:
        "Donec ac luctus massa. Donec hendrerit scelerisque massa sit amet imperdiet. In vitae eleifend ante. Sed luctus sem in nisl ullamcorper, at sodales turpis ultrices. Aenean eu felis eget dolor volutpat finibus quis sit amet augue.",
    },
    {
      id: 3,
      name: "Snooker",
      ...
      description:
        "Praesent varius felis vel malesuada pulvinar. Maecenas sed sem quis odio ultrices consequat. Nullam ut diam ac sem tempor molestie in sit amet nibh. Mauris ultricies eros eu sodales malesuada. Donec tempor magna ut ex elementum pellentesque. Praesent convallis, nunc ac ultricies volutpat, ligula ligula vehicula orci, quis mollis lectus urna sit amet sapien.",
    },
    {
      id: 4,
      name: "Volleyball",
